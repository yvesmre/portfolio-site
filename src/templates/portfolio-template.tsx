                    ...
                    <div id='gallery'>
                        ...
                        <main className='flex flex-row  flex-wrap w-[100%] mx-[10%]'  >
                            {images.map(({ node: image }: any) => {
                                ...
                                return <div className="h-1/4 w-1/4 min-w-48 p-2 m-4 drop-shadow-2xl bg-gray-300 bg-opacity-75 transition ease-in-out delay-100 hover:scale-110 hover:bg-opacity-100">
