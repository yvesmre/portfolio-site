                    ...
                    <div id='gallery'>
                        ...
                        <main className='flex flex-row  flex-wrap w-[100%] sm:mx-[10%]'  >
                            {images.map(({ node: image }: any) => {
                                ...
                                return <div className="h-1/4 sm:w-1/4 min-w-56 sm:ml-0 p-2 m-4 drop-shadow-2xl bg-gray-300 bg-opacity-75 transition ease-in-out delay-100 md:hover:scale-110 md:hover:bg-opacity-100">
